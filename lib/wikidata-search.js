...
WikidataSearch.prototype = {
     ...
     */
    _resolveProperties: (selectedLanguage, wikidataSearch, propertyList, finishedCb)=> {
        ...
        combinedUri = combinedUri + '&origin=*';
     ...
     * occurred.
     */
    getEntities: (entities, resolveProperties, cb)=>{
                        ...
                        for (var j in entity.claims) {
                            ...
                            if (data) {
                                ...
                                for(let dataId in data){
                                    let datum = data[dataId];
                                    let prop = datum.prop;
                                    let val = datum.val;
                                    let propType = datum.propType;
